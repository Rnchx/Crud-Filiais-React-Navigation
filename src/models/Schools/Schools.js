...
mockedSchools.map((school) => {
  const newSchool = new School(school.nome, school.fundacao, school.corPrimaria, school.corSecundaria,
     school.qntdFuncionarios, school.qntddAlunos, school.qntddTurmas, school.bairro, school.cidade, school.cep,
     school.telefone, school.email, school.nomeDoResponsavel, school.cargoDoResponsavel || 0);
